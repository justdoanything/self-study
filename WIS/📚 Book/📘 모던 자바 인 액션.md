...
- [stream method](#stream)
  ...
  - [takeWhile](#takewhile--거짓이-되면-작업을-중단하고-참이었던-요소를-저장)
  - [dropWhile](#dropwhile--거짓이-되면-작업을-중단하고-남은-요소를-저장)
  - [limit, skip](#limit-skip)
  - [flatMap](#flatmap--stream-평면화)
  - [anyMatch, allMatch, noneMatch](#anymatch-allmatch-nonematch)
  - [findAny, findFirst](#findany-findfirst)
  - [sorted](#sorted)
  - [reduce](#reduce)
  - [mapToInt](#기본형-특화-stream)
  - [range, rangeClosed](#숫자-범위-지정--range--rangeclosed)
  - [Stream.of, Arrays.stream](#값으로-stream-생성--streamof-arraysstream)
  - [File Stream](#file-stream)
- [collect method](#collect----부재--collectors)
  - [groupingBy](#groupingby-1)
  - [partitioningBy](#partitioningby)
  - [Collectors 함수](#collectors)
- [Collector Interface](#collector)
...
- ## Collector<T, A, R>
  ...
  `A` : 누적자로서 수집 과정에서 중간 결과를 누적하는 객체의 형식\
  `R` : 수집 연산 결과 객체의 형식
